...
public class ClientFrame extends JFrame{
	...
	private JPanel getServerTextPanel(Font font) {
		...
		JLabel lblNum = new JLabel ("Number of words (from Server's text): ");
		...
		lblWordNum.setBackground(Color.WHITE);
		lblWordNum.setOpaque(true);
	 ...
	 * 
	 * @param wordNum: number of words form the Server's text
	 */
