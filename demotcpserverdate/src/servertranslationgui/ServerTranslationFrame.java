...
/**
 * This class represent front end of the server side application
...
public class ServerTranslationFrame extends JFrame {
	...
	/*
	 * This constructor organize the GUI component for the window
	 */
	...
	/*
	 * This method create and arrange Swing components to display
	 * the status of server application
	 * 
	...
	/**
	 * This method create and arrange Swing components the 
	 * status of request send to the client.
	 * 
	 * @param font - Default font for the application
	 * @return Swing components organized in a panel.
	 */
	private JPanel getRequestStatusPanel() {
		...
		/*
		 *  Set default message when the frame launch 
		 *  for the first time
		 */
